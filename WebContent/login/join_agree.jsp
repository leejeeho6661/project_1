...
<body>
		...
		<h1 class="text-center" >책방</h1>
		<h3 class="text-center">사업자 단체 가입 약관 동의</h3>
		<p class = "text-center">서비스 약관 및 개인정보 수집 이용에 동의해 주세요</p>
		<form action="View_Signup.jsp" method="post" onsubmit="return checkForm();">
		<fieldset>
		<legend>책방 서비스 약관 동의</legend>
			<div class="form-group row">
				<div class="col-sm-6">
					<strong>책방 서비스 약관 동의</strong>
				</div>
				<div class="col-sm-6 text-right">
					<input type="checkbox" name="agree" id="agree1" title="책방 서비스 약관 동의 체크박스입니다." />
				</div>
			<div class="form-group">
				<textarea name="agreement2" rows="10" cols="60" id="agreemant1" class="form-control " title="이용약관동의입니다." readonly="readonly">//---------------------------------------  책방 서비스 약관 동의
//---------------------------------------  책박 서비스 약관 동의
제 1 장 총 칙
제 1 조 목적
...
②
회사가 제공하는 유료서비스에 대한 이용요금의 결제 방법은 핸드폰결제, 신용카드결제, 일반전화결제, 계좌이체, 무통장입금, 책방캐쉬 결제 등이 있으며 각 유료서비스마다 결제 방법의 차이가 있을 수 있습니다.
...
본 약관은 2016년 10월 7일부터 적용됩니다. 단, 본 약관의 공지 시점으로부터 적용일 전일까지 기간 동안에 가입한 신규회원에 대해서는 회원 가입시부터 본 약관이 적용됩니다.
				...
				<div class="form-group row">
				<div class="col-sm-6">
					<strong>책방 개인정보 수집 및 이용 동의</strong>
				</div>
				<div class="col-sm-6 text-right">
					<input type="checkbox" name="agree" id="agree2" title="책방 개인정보 수집 및 이용 동의 체크박스입니다." />
				</div>
			<div class="form-group">
				<textarea name="agreement2" rows="10" cols="60" id="agreemant2" class="form-control " title="개인정보 수집 및 이용 동의입니다." readonly="readonly">//---------------------------------------  책방 개인정보 수집 및 이용 동의
...
더 자세한 내용에 대해서는 개인정보처리방침을 참고하시기 바랍니다.</textarea>
		</div>
		</div>
		
		<div class="text-center">
			<input type="submit" title="동의하기 버튼입니다." value="동의하기" class="btn btn-warning"/>
		</div>
		</fieldset>
		</form>
		</div><!-- container END-->
